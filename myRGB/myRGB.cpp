...
using namespace std;
using namespace cv;
string Path_paramFile = "../Depthdataset/dorm/myDepthMono.yaml"; //相机参数
...
int main(int argc, char**argv)
{
    ...
    //检测是否成功读取数据集
    int nImages = RGB_img_Paths.size();
    ...
    //声明SLAM系统
    ORB_SLAM3::System SLAM(Path_vocFile, Path_paramFile, ORB_SLAM3::System::MONOCULAR, true);
    cv::Mat imRGB;
    // 记录系统时间
